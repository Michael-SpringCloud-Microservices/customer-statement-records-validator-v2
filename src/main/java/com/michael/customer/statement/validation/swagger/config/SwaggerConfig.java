package com.michael.customer.statement.validation.swagger.config;
...
public class SwaggerConfig {
	...
	public Docket api(){
		...
		.select().apis(RequestHandlerSelectors.basePackage("com.michael.customer.statement.validation.controller"))
	...
	private ApiInfo metaData() {
		...
		.description("RESTful API for customer statement records validation")
		.version("version 1.0")
